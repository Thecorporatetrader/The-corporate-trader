...
const freeLink = requestLink('Hi TCT, I would like the free 90%-automated TCT algo for MT5. Please explain the setup, what I need to control manually, and how to get access.');
      ...
      <div className="ta-wrap">
        <header className="ta-hero">
          ...
          <aside className="ta-console" aria-label="Current free TCT algo capabilities">
            ...
            <div className="ta-console-title"><div><p className="ta-eyebrow">AUTOMATION LEVEL</p><strong>90<span>%</span></strong></div><div className="ta-price-label">FREE<small>For everyone</small></div></div>
            ...
            <p className="ta-small">90% describes the product’s automation level—not a win rate. Setup, risk settings and oversight remain your responsibility.</p>
          </aside>
        </header>
        ...
        <section className="ta-section" id="free">
          <div className="ta-heading"><div><p className="ta-eyebrow">01 / YOUR CURRENT TCT ALGO</p><h2>Less manual execution.<br />More structured trading.</h2></div><span className="ta-tag">90% AUTOMATED · ₹0</span></div>
          <p className="ta-intro">Our current algo is free for everyone. It handles the execution and trade-management tasks below according to its configured rules. The team will explain the remaining manual steps and supported settings before you start.</p>
        ...
        <section className="ta-section ta-faq">
          ...
          <details><summary>What is free, and what costs ₹19,999?</summary><p>The current 90%-automated TCT algo is free for everyone. We also offer a free custom build after reviewing your strategy and agreeing the scope. The separate 100%-automated TCT algo is listed at ₹19,999; contact the team for its full purchase terms.</p></details>
          <details><summary>Does 90% or 100% mean a win rate?</summary><p>No. These are automation labels, not success rates. No win rate or return is promised. You still need to configure the system, understand its limitations and monitor risk.</p></details>
