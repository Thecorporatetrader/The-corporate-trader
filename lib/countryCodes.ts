...
/**
 * Country calling codes for the phone number field used on Login, Register and Contact.
 * India is listed first since it is TCT's default market; the rest are alphabetical so
 * traders outside India can still find and select their own country code.
 */
