...
export const products: Product[] = [
  {
    icon: Bot,
    title: 'TCT Algo',
    text: 'Manage take profit, stop loss, trailing stops, and risk-to-reward settings with our MT5 Expert Advisor. Your first TCT MT5 algo is free.',
    href: '/algo',
    tag: 'MT5 EA',
  },
  {
    ...
    href: '/algo#custom-algo-section',
    tag: 'BUILT FOR YOU',
  },
  {
    icon: Smartphone,
    title: 'TCT Trading Journal',
    text: 'Review your decisions, spot patterns, and build better habits with an Android trading journal and structured performance ratings. Coming soon to Google Play.',
    href: '/journal',
    tag: 'ANDROID',
  },
  {
    ...
    text: 'Build your knowledge step by step with free resources on market structure, risk management, and trading discipline.',
    href: '/library',
    tag: 'LEARN',
  },
];
